...
Partial Friend NotInheritable Class DeviceManagement
	...
	''' </returns>
	''' 
    Friend Function RegisterForDeviceNotifications(ByVal devicePathName As String, ByVal formHandle As IntPtr, ByVal classGuid As Guid, ByRef deviceNotificationHandle As IntPtr) As Boolean
